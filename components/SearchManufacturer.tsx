...
const SearchManufacturer = ({
  ...
  return (
    <div className="search-manufacturer rounded-none">
      <Combobox
        value={gameSeries}
        onChange={(value) => setGameSeries(value ?? "")}
      >
        <div className="relative w-full">
          ...
          >
            <Combobox.Options
              className="absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm combo-options"
              static
            >
